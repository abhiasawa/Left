...
data class UserPreferencesData(
    ...
    val remainingColor: String = "#EDE9DF",
    val currentIndicatorColor: String = "#EDE9DF",
...
class UserPreferencesRepository(private val context: Context) {
    ...
    val preferences: Flow<UserPreferencesData> = context.dataStore.data.map { prefs ->
        UserPreferencesData(
            ...
            remainingColor = prefs[PreferenceKeys.REMAINING_COLOR] ?: "#EDE9DF",
            currentIndicatorColor = prefs[PreferenceKeys.CURRENT_INDICATOR_COLOR] ?: "#EDE9DF",
